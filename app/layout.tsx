    ...
    <html lang="pt-BR" className={`${poppins.variable} ${manrope.variable} antialiased`}>
      <body>
        ...
        <Script id="utmify-pixel" strategy="afterInteractive">
          {`window.pixelId="6a5c54a45d579e7b97aaf4ce";var a=document.createElement("script");a.async=true;a.src="https://cdn.utmify.com.br/scripts/pixel/pixel.js";document.head.appendChild(a);`}
        </Script>
        <Script
        ...
        <Script id="clarity" strategy="lazyOnload">
          {`(function(c,l,a,r,i,t,y){c[a]=c[a]||function(){(c[a].q=c[a].q||[]).push(arguments)};t=l.createElement(r);t.async=1;t.src="https://www.clarity.ms/tag/"+i;y=l.getElementsByTagName(r)[0];y.parentNode.insertBefore(t,y);})(window,document,"clarity","script","xo7jsjm0j0");`}
        </Script>
        <noscript>
